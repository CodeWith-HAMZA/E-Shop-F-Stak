  ...
  return ( 
        ...
        <div className="h-screen grid grid-cols-3">
            <div className="lg:col-span-2 col-span-3 bg-indigo-50 space-y-8 px-12">
                ...
                <button className="submit-button px-4 py-3 rounded-md bg-purple-500 hover:bg-purple-600 text-white focus:ring focus:outline-none w-full text-xl font-semibold transition-colors">
                    Pay €846.98
                </button>
            </div>
            <div className="col-span-1 bg-white lg:block hidden">
                   ...
                   {cartItems. map(({name, images, price, quantity, description}: CartItem) => <li className="grid grid-cols-6 gap-2 border-b-1">
                        ...
                        <div className="col-span-2 pt-3">
                            <div className="flex items-center space-x-2 text-sm justify-between">
                                ...
                                <span className="text-purple-400 font-semibold inline-block">{price}</span>
                            </div>
                        </div>
                    </li>)}
                    <li className="grid grid-cols-6 gap-2 border-b-1">
                        ...
                        <div className="col-span-2 pt-3">
                            <div className="flex items-center space-x-2 text-sm justify-between">
                                ...
                                <span className="text-purple-400 font-semibold inline-block">€785</span>
                            </div>
                        </div>
                    </li>
                </ul>
                <div className="px-8 border-b">
                    <div className="flex justify-between py-4 text-gray-600">
                        <span>Subtotal</span>
                        <span className="font-semibold text-purple-500">€846.98</span>
                    </div>
                    <div className="flex justify-between py-4 text-gray-600">
                        <span>Shipping</span>
